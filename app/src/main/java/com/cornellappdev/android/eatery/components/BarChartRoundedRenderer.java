...
public class BarChartRoundedRenderer extends BarLineScatterCandleBubbleRenderer {
    ...
    private void drawDataSet(Canvas c, IBarDataSet dataSet, int index) {
    ...
    private void prepareBarHighlight(float x, float y1, float y2, float barWidthHalf, Transformer trans) {
     ...
     * @param high
     */
    private void setHighlightDrawPos(Highlight high, RectF bar) {
